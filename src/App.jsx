...
const DevPortfolio = () => {
  ...
  const projectsData = [
    ...
    },
    {
      ...
      longDescription: {
        pt: "Plataforma multivendor para o nicho pet, permitindo que diversos lojistas vendam produtos e serviços. Integração com API do PagBank para split de pagamentos.",
        en: "Multivendor platform for the pet niche, allowing various shopkeepers to sell products and services. Integration with PagBank API for payment splitting.",
      },
    ...
    },
    {
      ...
      longDescription: {
        pt: "Plataforma de delivery estilo iFood para restaurantes, com painel administrativo Desktop em Electron.",
        en: "iFood-style delivery platform for restaurants, with Desktop administrative panel in Electron.",
      },
